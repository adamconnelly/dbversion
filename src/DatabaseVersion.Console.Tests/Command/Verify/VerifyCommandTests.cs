using dbversion.Console.Command.Verify;
...
namespace dbversion.Console.Tests.Command.Create
{
    ...
    public class VerifyCommandTests
    {
        ...
        public void ShouldHaveCorrectCommandName()
        {
            ...
            // Assert
            Assert.Equal("verify", name);
        }

        [Fact]
        public void ShouldUseDatabaseCreatorToCreateDatabase2()
        {
            // Arrange
            var command = this.VerifyCommand();
        ...
        private CreateCommand VerifyCommand()
        {
            var command = new VerifyCommand();
